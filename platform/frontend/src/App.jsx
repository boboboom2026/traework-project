...
import Orchestration from "./pages/Orchestration.jsx";
...
const ICONS = {
  ...
  orchestration: <I d={<><rect x="3" y="3" width="6" height="6" rx="1.5" /><rect x="15" y="15" width="6" height="6" rx="1.5" /><path d="M9 6h6a3 3 0 0 1 3 3v6" /></>} />,
...
const NAV = [
  ...
  { id: "orchestration", label: "协作编排", group: "协作核心" },
...
const PAGES = {
  dashboard: Dashboard, workbench: Workbench, agents: Agents, orchestration: Orchestration,
  apps: Apps,
